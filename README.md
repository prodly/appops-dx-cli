...
mooverdxcli/0.0.9 darwin-x64 node-v11.6.0
...
_See code: [src/commands/moover/deploy.ts](https://github.com/prodly/mooverdxcli/blob/v0.0.9/src/commands/moover/deploy.ts)_
<!-- commandsstop -->
